      ...
      <body>
        ...
        <div class="container my-container py-3" x-data>
          ...
          <div class="d-flex flex-wrap align-items-center gap-2 mb-3">
            ...
            <div>
              <button class="btn my-btn me-2" id="btn-copy-link" type="button" x-text="$t('copyLink')"></button>
              <button class="btn my-btn" id="btn-show-qr" data-bs-toggle="modal" data-bs-target="#qr-modal">
            ...
            <div class="modal fade" id="qr-modal" tabindex="-1" aria-labelledby="qr-modal-label">
              <div class="modal-sm modal-dialog modal-dialog-centered">
                <div class="modal-content my-modal border border-0 rounded-4">
                  <div class="modal-header border border-0">
                    <h1 class="modal-title fs-5 fw-bold me-auto" id="qr-modal-label" x-text="$t('subscription')"></h1>
        ...
        <script>
          ...
          document.addEventListener('DOMContentLoaded', () => {
            ...
            const btnPrefGuideTab = document.querySelector(
              `.dropdown-item[data-bs-target="${getPreferredGuideTab()}"]`,
            );
            bootstrap.Tab.getOrCreateInstance(btnPrefGuideTab).show();
            showActiveDropdownButton(btnGuide, btnPrefGuideTab);
            document.querySelectorAll('.dropdown-item[data-bs-target]').forEach(btn => {
              btn.addEventListener('click', () => {
